...
class Form {
    ...
    public function __toString() {
        ...
        $o = $tab."<form ".$this->attrs->get_attrs().">"."\n";
...
class Form_Text extends Form_Input {
    ...
    public function __toString() {
        ...
        $field = '<input'.$id.$this->attrs->get_attrs().$value.' />';
...
class Form_Hidden extends Form_Input {
    ...
    public function __toString() {
		$tab = '';
        return $tab.'<input'.$this->attrs->get_attrs().' value="'.htmlspecialchars($this->value).'" />';
    }
}
...
class Form_Password extends Form_Text {
    ...
    public function __toString() {
        ...
        $field = '<input'.$id.$this->attrs->get_attrs().' />';
        return $tab.sprintf("%2\$s%1\$s%3\$s", $field, $label, $errors);
    }
}
...
class Form_Submit extends Form_Input {
    ...
    public function __toString() {
        ...
        $field = '<input'.$this->attrs->get_attrs().$value.' />';
...
class Form_Radio extends Form_Input {
    ...
    public function __toString() {
        ...
        foreach($this->choices as $v => $c) {
            ...
            $fields[] = '<input'.$id.$this->attrs->get_attrs().$checked.' /> '.$label.'<br />';
...
class Form_Select extends Form_Input {
    ...
    public function __toString() {
        ...
        $field = '<select'.$id.$this->attrs->get_attrs().'>'."\n".implode("\n", $fields)."\n$tab</select>";
        return $tab.sprintf("%2\$s%1\$s%3\$s", $field, $label, $errors);
    }
}
...
class Form_Checkbox extends Form_Input {
    ...
    public function __toString() {
        ...
        $field = '<input'.$id.$this->attrs->get_attrs().$value.$checked.' />';
...
class Form_Textarea extends Form_Field {
    ...
    public function __toString() {
        ...
        $field = '<textarea'.$id.$this->attrs->get_attrs().'>'.$value.'</textarea>';
        return $tab.sprintf("%2\$s%1\$s%3\$s", $field, $label, $errors);
    }
}
